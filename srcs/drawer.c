...
/*   Updated: 2017/06/02 10:42:50 by nboste           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!(env->rend.rend_sdl = SDL_CreateRenderer(env->win.win_sdl, -1,
...
{
	SDL_UpdateTexture(rend->texture_sdl, NULL,
			rend->pixels, rend->size.x * sizeof(t_uint32));
